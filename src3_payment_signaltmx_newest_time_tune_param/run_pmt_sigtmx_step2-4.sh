...
if [ $opt == 1 ]; then
	...
	model_dir=/home/junhe/fraud_model/Results/Model_Results_Signal_Tmx_v3pmt_woeSmth=0_newest_time/RandomForest_signal_rc_tmx_rc_ind/
	impwoe_dir=/home/junhe/fraud_model/Data/Model_Data_Signal_Tmx_v3pmt_newest_time/
