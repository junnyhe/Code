...
if len(sys.argv) <=1:
    data_dir=''#/home/junhe/fraud_model/Data/Model_Data_Signal_Tmx_v3pmt_newest_time/'
    result_dir=''#/home/junhe/fraud_model/Results/Model_Results_Signal_Tmx_v3pmt_woeSmth=0_newest_time/'
elif len(sys.argv) ==3:
    data_dir=sys.argv[1]
