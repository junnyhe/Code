...
python ${code_dir}step2_model_data_prep_signal_tmx/step2d_model_data_impute_woe.py $data_dir $support_dir >>${log_dir}log.txt  2>&1
python ${code_dir}step3_model_train/step3_model_train_signal_tmx_v2.py $data_dir $support_dir $result_dir >>${log_dir}log.txt  2>&1
...
python ${code_dir}step2_model_data_prep_signal_tmx/step2d_model_data_impute_woe.py $wd_data_dir $support_dir >>${log_dir}log.txt  2>&1
python ${code_dir}step3_model_train/step3_model_train_signal_tmx_v2.py $wd_data_dir $support_dir $result_dir >>${log_dir}log.txt  2>&1
...
python ${code_dir}step3_model_data_prep_signal_tmx/step3a_model_data_rc_tmxrc_ind_creation_main.py $data_dir $support_dir >>${log_dir}log.txt  2>&1
python ${code_dir}step3_model_data_prep_signal_tmx/step3b_model_data_feature_creation_main.py $data_dir $support_dir >>${log_dir}log.txt  2>&1
python ${code_dir}step3_model_data_prep_signal_tmx/step3c_support_impute_woe_mapping_calculation.py $data_dir $support_dir >>${log_dir}log.txt  2>&1
...
python ${code_dir}step4_model_train/step4_model_train_signal_tmx_v2.py $data_dir $support_dir $result_dir >>${log_dir}log.txt
...
python ${code_dir}step3_model_data_prep_signal_tmx/step3a_model_data_rc_tmxrc_ind_creation_main.py $wd_data_dir $support_dir >>${log_dir}log.txt  2>&1
python ${code_dir}step3_model_data_prep_signal_tmx/step3b_model_data_feature_creation_main.py $wd_data_dir $support_dir >>${log_dir}log.txt  2>&1
python ${code_dir}step3_model_data_prep_signal_tmx/step3c_support_impute_woe_mapping_calculation.py $wd_data_dir $support_dir >>${log_dir}log.txt  2>&1
...
python ${code_dir}step4_model_train/step4_model_train_signal_tmx_v2.py $wd_data_dir $support_dir $result_dir >>${log_dir}log.txt
