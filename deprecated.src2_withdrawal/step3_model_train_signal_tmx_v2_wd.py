...
sys.path.append("/Users/junhe/Box Sync/Documents/workspace/fraud_model/tools/model_tools")
...
def model_test_data_evaluation(test_data_file, var_list_filename, model_file, output_dir, output_suffix):
    ...
    t0=time.time()
    target_name='target'  
    X,y = load_data(test_data_file, var_list_filename, target_name)
...
def model_test_data_evaluation_comp_ruletag(test_data_file, var_list_filename, model_file, output_dir, output_suffix, good_downsample_rate):
    ...
    X,y,key,tag = load_data_with_key_tag(test_data_file, var_list_filename, target_name, key_name, tag_name)
    print "Loading test data done, taking ",time.time()-t0,"secs"
...
joblist=[
        ...
        #('RandomForest_tmxpayer_tmxpayee','model_var_list_tmxpayer_tmxpayee.csv'),
        #('RandomForest_tmxpayerpayee_comp','model_var_list_tmxpayerpayee_comp.csv'),
        #('RandomForest_signal_tmxboth','model_var_list_signal_tmxboth.csv'),
        #('RandomForest_signal_tmxboth_600vars','model_var_list_signal_tmxboth_600vars.csv'),
        #('RandomForest_signal_tmxboth_500vars','model_var_list_signal_tmxboth_500vars.csv'),
        #('RandomForest_signal_tmxboth_400vars','model_var_list_signal_tmxboth_400vars.csv'),
        #('RandomForest_signal_tmxboth_300vars','model_var_list_signal_tmxboth_300vars.csv'),
        #('RandomForest_signal_tmxboth_200vars','model_var_list_signal_tmxboth_200vars.csv'),
        #('RandomForest_signal_tmxboth_100vars','model_var_list_signal_tmxboth_100vars.csv'),
        #('RandomForest_signal_tmxboth_50vars','model_var_list_signal_tmxboth_50vars.csv'),
        ]
...
data_dir='/Users/junhe/Box Sync/Documents/Data/Model_Data_Signal_Tmx_v2wd/'

#result_dir='/Users/junhe/Box Sync/Documents/Results/Model_Results_Signal_Tmx_v2wd/'
#good_downsample_rate = 1 #used to scale back hit rate

#result_dir='/Users/junhe/Box Sync/Documents/Results/Model_Results_Signal_Tmx_v2wd_ds=0.2/'
#good_downsample_rate = 0.2 #used to scale back hit rate

result_dir='/Users/junhe/Box Sync/Documents/Results/Model_Results_Signal_Tmx_v2wd_ds=1_smth=500/'
good_downsample_rate = 1 #used to scale back hit rate
...
for job in joblist:
    ...
    ins_file=data_dir+'model_data_wd_ins_ds_fc_imp_woe.csv.gz'
    oos_file=data_dir+'model_data_wd_oos_ds_fc_imp_woe.csv.gz'
    ...
    test_data_file = data_dir+'model_data_wd_oos_ds_fc_imp_woe.csv.gz'
    ...
    test_data_file = data_dir+'test_data_sept_wd_ds_fc_imp_woe.csv.gz'
    model_file = output_dir+"model.p"
    ...
    test_data_file = data_dir+'test_data_oct_wd_ds_fc_imp_woe.csv.gz'
    model_file = output_dir+"model.p"
    ...
    test_data_file = data_dir+'test_data_nov_wd_ds_fc_imp_woe.csv.gz'
    model_file = output_dir+"model.p"
    ...
    test_data_file = data_dir+'test_data_dec_wd_ds_fc_imp_woe.csv.gz'
    model_file = output_dir+"model.p"
