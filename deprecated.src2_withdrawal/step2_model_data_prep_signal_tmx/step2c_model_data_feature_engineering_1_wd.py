...
def feature_creation(input_file,output_file):
    ...
    print "Running feature creation for file:", input_file
    # input output files
    ...
    # datetime var list
    time_var_filename='/Users/junhe/Box Sync/Documents/Data/Model_Data_Signal_Tmx_v2/var_list_time_diff.csv'
    ...
    # ppcmp var list 
    ppcmp_var_filename='/Users/junhe/Box Sync/Documents/Data/Model_Data_Signal_Tmx_v2/var_list_ppcmp.csv'
    ...
    # leven dist var list
    leven_dist_var_filename='/Users/junhe/Box Sync/Documents/Data/Model_Data_Signal_Tmx_v2/var_list_leven_dist.csv'
    ...
    print "Feature creation DONE for file:", input_file


work_dir='/Users/junhe/Box Sync/Documents/Data/Model_Data_Signal_Tmx_v2wd/'

# ins
input_file=work_dir+"model_data_wd_ins_ds.csv.gz"
output_file=work_dir+"model_data_wd_ins_ds_fc.csv.gz"
#feature_creation(input_file,output_file)

# oos
input_file=work_dir+"model_data_wd_oos_ds.csv.gz"
output_file=work_dir+"model_data_wd_oos_ds_fc.csv.gz"
feature_creation(input_file,output_file)

# test1
input_file=work_dir+"test_data_sept_wd_ds.csv.gz"
output_file=work_dir+"test_data_sept_wd_ds_fc.csv.gz"
feature_creation(input_file,output_file)

# test2
input_file=work_dir+"test_data_oct_wd_ds.csv.gz"
output_file=work_dir+"test_data_oct_wd_ds_fc.csv.gz"
feature_creation(input_file,output_file)

# test3
input_file=work_dir+"test_data_nov_wd_ds.csv.gz"
output_file=work_dir+"test_data_nov_wd_ds_fc.csv.gz"
feature_creation(input_file,output_file)

# test4
input_file=work_dir+"test_data_dec_wd_ds.csv.gz"
output_file=work_dir+"test_data_dec_wd_ds_fc.csv.gz"
feature_creation(input_file,output_file)
