...
oos_frac=0.2 #fraction used for oos
if len(sys.argv) <=1:
    in_dir='/fraud_model/Data/Model_Data_Signal_Tmx_v2pmt_signalonly_newest_time_test/'
    out_dir='/fraud_model/Data/Model_Data_Signal_Tmx_v2wd_signalonly_newest_time_test/'
    #in_dir=''
    #out_dir=''
elif len(sys.argv) ==3:
    in_dir=sys.argv[1]
