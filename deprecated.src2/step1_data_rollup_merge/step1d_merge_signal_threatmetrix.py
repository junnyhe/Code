...
def merge_all_data_sources( day_start,  n_Days):
    ...
    for iDay in range(nDays):
        ...
        file2="/fraud_model/Data/Raw_Data/threatmetrix_payer/threatmetrix_payer_flat_"+str(day)+".csv.gz"
        file3="/fraud_model/Data/Raw_Data/threatmetrix_payee/threatmetrix_payee_flat_"+str(day)+".csv.gz"
        file_out="/fraud_model/Data/Raw_Data/merged_data/signals_threatmetrix_payer_payee_"+str(day)+".csv.gz"
        file_out_tmp= "/fraud_model/Data/Raw_Data/merged_data/merge_tmp_"+str(day)+".csv.gz"
