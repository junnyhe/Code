...
if [[ $performance_test_msg =~ "FAIL" ]]; then
    title="[Models] New Model: One or More Models Failed Performance Tests. Models that passed were deployed. [$(date)]"
    ...
    title="[Models] New Model: All Fraud Models were Successfully refreshed and deployed [$(date)]"
