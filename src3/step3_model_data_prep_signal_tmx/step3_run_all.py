...
def model_data_processing_batch(input_file,output_file):
    ...
    time_var_filename='/fraud_model/Data/Model_Data_Signal_Tmx_v3pmt/var_list_time_diff.csv'
    ppcmp_var_filename='/fraud_model/Data/Model_Data_Signal_Tmx_v3pmt/var_list_ppcmp.csv'
    leven_dist_var_filename='/fraud_model/Data/Model_Data_Signal_Tmx_v3pmt/var_list_leven_dist.csv'
