...
joblist=[
        ('RandomForest_tmxrc_ind','model_var_list_tmxrc_ind.csv'), # suffix and varlist
        ]
...
result_dir='/home/junhe/fraud_model/Results/Model_Results_Signal_Tmx_v3pmt_tmxrc_ind/'
...
for job in joblist:
    ...
    ins_file=data_dir+'model_data_pmt_ins_ds_tmxrc_ind.csv.gz'
    oos_file=data_dir+'model_data_pmt_oos_ds_tmxrc_ind.csv.gz'
    ...
    test_data_file = data_dir+'model_data_pmt_oos_ds_tmxrc_ind.csv.gz'
    ...
    test_data_file = data_dir+'test_data_sept_pmt_ds_tmxrc_ind.csv.gz'
    model_file = output_dir+"model.p"
    ...
    test_data_file = data_dir+'test_data_oct_pmt_ds_tmxrc_ind.csv.gz'
    model_file = output_dir+"model.p"
    ...
    test_data_file = data_dir+'test_data_nov_pmt_ds_tmxrc_ind.csv.gz'
    model_file = output_dir+"model.p"
    ...
    test_data_file = data_dir+'test_data_dec_pmt_ds_tmxrc_ind.csv.gz'
    model_file = output_dir+"model.p"
