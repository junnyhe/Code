...
filename1="/home/junhe/fraud_model/Data/Model_Data_Signal_Tmx_v3pmt/4cmp_model_data_pmt_oos_ds_rcind_fc_imp_woe.csv.gz"
file1=gzip.open(filename1,'rb')
filecsv1 = csv.DictReader(file1)

filename2="/home/junhe/fraud_model/Data/Model_Data_Signal_Tmx_v3pmt/model_data_pmt_oos_ds_rcind_fc_imp_woe.csv.gz"
