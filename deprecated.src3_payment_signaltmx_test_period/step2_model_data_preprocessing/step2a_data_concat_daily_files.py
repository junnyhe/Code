...
out_dir = "/home/junhe/fraud_model/Data/Model_Data_Signal_Tmx_v3pmt_test_period/"
    
    
# model data jan/feb
start_day=datetime.date(2014,11,1) #start date
nDays=30 # number of days to process
out_file_name='model_data_novnov'
cat_daily_files(start_day,out_file_name)

# model data jan/feb
start_day=datetime.date(2014,10,1) #start date
nDays=61 # number of days to process
out_file_name='model_data_octnov'
cat_daily_files(start_day,out_file_name)

# model data nov/dec
start_day=datetime.date(2014,9,1) #start date
nDays=91 # number of days to process
out_file_name='model_data_septnov'
cat_daily_files(start_day,out_file_name)

# model data sept/oct
start_day=datetime.date(2014,8,1) #start date
nDays=122 # number of days to process
out_file_name='model_data_augnov'
cat_daily_files(start_day,out_file_name)

# model data jul/aug
start_day=datetime.date(2014,7,1) #start date
nDays=153 # number of days to process
out_file_name='model_data_julnov'
cat_daily_files(start_day,out_file_name)
...
start_day=datetime.date(2014,8,1) #start date
nDays=31 # number of days to process
out_file_name='test_data_aug'
cat_daily_files(start_day,out_file_name)

# test data jul
start_day=datetime.date(2014,7,1) #start date
nDays=31 # number of days to process
out_file_name='test_data_jul'
cat_daily_files(start_day,out_file_name)
