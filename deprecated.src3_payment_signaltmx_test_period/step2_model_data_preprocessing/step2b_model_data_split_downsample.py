...
def train_validation_split(input_file,oos_frac,ins_file,oos_file):
    ...
    print "split to train and validation data sets for file:",input_file
...
input_file=work_dir+"model_data_septnov_pmt.csv.gz"
ins_file=work_dir+"model_data_pmt_ins.csv.gz"
oos_file=work_dir+"model_data_pmt_oos.csv.gz"
...
input_file=work_dir+"test_data_feb_pmt.csv.gz"
output_file=work_dir+"test_data_feb_pmt_ds.csv.gz"
#downsample_filter(input_file,output_file, downsamle_fieldname='target', downsample_field_equal_value='0', downsample_frac=downsample_frac)

input_file=work_dir+"test_data_jan_pmt.csv.gz"
output_file=work_dir+"test_data_jan_pmt_ds.csv.gz"
#downsample_filter(input_file,output_file, downsamle_fieldname='target', downsample_field_equal_value='0', downsample_frac=downsample_frac)
