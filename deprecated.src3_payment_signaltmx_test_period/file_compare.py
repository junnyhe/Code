...
filename1="/fraud_model/Data/Model_Data_Signal_Tmx_v3pmt_newest_time/4cmp_model_data_pmt_oos_ds_rcind_fc_imp_woe.csv.gz"
file1=gzip.open(filename1,'rb')
filecsv1 = csv.DictReader(file1)

filename2="/fraud_model/Data/Model_Data_Signal_Tmx_v3pmt_newest_time/model_data_pmt_oos_ds_rcind_fc_imp_woe.csv.gz"
