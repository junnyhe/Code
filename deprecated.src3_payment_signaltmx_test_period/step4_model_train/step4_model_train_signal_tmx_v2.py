...
data_dir='/home/junhe/fraud_model/Data/Model_Data_Signal_Tmx_v3pmt_test_period/'

result_dir='/home/junhe/fraud_model/Results/Model_Results_Signal_Tmx_v3pmt_woeSmth=0_test_period/'
...
for job in joblist:
    ...
    result_summary.append(['Valid']+format_results_one_case(ks, auc, lorenz_curve_capt_rate, good_downsample_rate) + rule_model_rates)# append results for one case to summary
    
    test_data_file = data_dir+'test_data_feb_pmt_ds_rcind_fc_imp_woe.csv.gz'
    model_file = output_dir+"model.p"
    ...
    test_data_file = data_dir+'test_data_jan_pmt_ds_rcind_fc_imp_woe.csv.gz'
    model_file = output_dir+"model.p"
    ...
    test_data_file = data_dir+'test_data_aug_pmt_ds_rcind_fc_imp_woe.csv.gz'
    model_file = output_dir+"model.p"
    ...
    test_data_file = data_dir+'test_data_jul_pmt_ds_rcind_fc_imp_woe.csv.gz'
    model_file = output_dir+"model.p"
