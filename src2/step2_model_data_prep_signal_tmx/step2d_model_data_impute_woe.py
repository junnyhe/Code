...
ins_file="model_data_pmt_ins_ds_fc.csv.gz" # in sample data used to calculate the stats
...
#csv_EDD(work_dir+'model_data_pmt_ins_ds_fc_imp.csv.gz')
...
input_file='model_data_pmt_ins_ds_fc_imp.csv.gz'
...
csv_EDD(work_dir+'model_data_pmt_ins_ds_fc_imp_woe.csv.gz')
