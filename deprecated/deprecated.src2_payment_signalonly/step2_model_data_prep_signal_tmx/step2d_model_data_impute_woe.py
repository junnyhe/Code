...
ins_file="newest_model_data_pmt_ins_ds.csv.gz" # in sample data used to calculate the stats
imp_median_var_list_file="var_list_impute_median.csv" # var list for imputing missing to median 
imp_zero_var_list_file="var_list_impute_zero.csv" # var list for imputeing missing to zero
...
################################################################################
input_list = (
              [work_dir,"newest_model_data_pmt_ins_ds.csv.gz","newest_model_data_pmt_ins_ds_imp.csv.gz"], 
              [work_dir,"newest_model_data_pmt_oos_ds.csv.gz","newest_model_data_pmt_oos_ds_imp.csv.gz"]
              )
            # Inputs: impute_replace_pickle(work_dir,input_file,output_file)
pool = Pool(processes=3)
pool.map(impute_replace_pickle_helper, input_list)
...
#csv_EDD(work_dir+'newest_model_data_pmt_ins_ds_imp.csv.gz')
...
input_file='newest_model_data_pmt_ins_ds_imp.csv.gz'
woe_var_list_file='var_list_woe.csv'
...
input_list = (
              [work_dir,"newest_model_data_pmt_ins_ds_imp.csv.gz","newest_model_data_pmt_ins_ds_imp_woe.csv.gz"],
              [work_dir,"newest_model_data_pmt_oos_ds_imp.csv.gz","newest_model_data_pmt_oos_ds_imp_woe.csv.gz"]
              )
            # Inputs: woe_assign_pickle(work_dir,input_file,output_file)
pool = Pool(processes=3)
pool.map(woe_assign_pickle_helper, input_list)
...
csv_EDD(work_dir+'newest_model_data_pmt_ins_ds_imp_woe.csv.gz')
