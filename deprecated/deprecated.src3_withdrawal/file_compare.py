...
filename1="/fraud_model/Data/Model_Data_Signal_Tmx_v3wd/4cmp_model_data_wd_oos_ds_rcind_fc_imp_woe.csv.gz"
file1=gzip.open(filename1,'rb')
filecsv1 = csv.DictReader(file1)

filename2="/fraud_model/Data/Model_Data_Signal_Tmx_v3wd/model_data_wd_oos_ds_rcind_fc_imp_woe.csv.gz"
