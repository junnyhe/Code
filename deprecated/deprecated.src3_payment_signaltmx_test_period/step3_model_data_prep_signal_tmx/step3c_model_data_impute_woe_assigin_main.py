...
if __name__=="__main__":  
    ...
    input_list = (
                  ...
                  [work_dir+"test_data_jul_pmt_ds_rcind_fc.csv.gz",work_dir+"test_data_jul_pmt_ds_rcind_fc_imp_woe.csv.gz"],
                  [work_dir+"test_data_aug_pmt_ds_rcind_fc.csv.gz",work_dir+"test_data_aug_pmt_ds_rcind_fc_imp_woe.csv.gz"],
                  ...
                  [work_dir+"test_data_jan_pmt_ds_rcind_fc.csv.gz",work_dir+"test_data_jan_pmt_ds_rcind_fc_imp_woe.csv.gz"],
                  [work_dir+"test_data_feb_pmt_ds_rcind_fc.csv.gz",work_dir+"test_data_feb_pmt_ds_rcind_fc_imp_woe.csv.gz"]
                  )
