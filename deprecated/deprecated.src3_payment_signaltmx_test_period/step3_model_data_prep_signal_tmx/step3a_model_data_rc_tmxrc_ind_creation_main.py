...
def rc_tmxrc_ind_creation_batch(input_file,output_file):
    ...
    print "Add indicator for file:",input_file
...
if __name__=="__main__":
    ...
    input_list = (
                  ...
                  #[work_dir+"test_data_jul_pmt_ds.csv.gz",work_dir+"test_data_jul_pmt_ds_rcind.csv.gz"],
                  #[work_dir+"test_data_aug_pmt_ds.csv.gz",work_dir+"test_data_aug_pmt_ds_rcind.csv.gz"],
                  ...
                  #[work_dir+"test_data_jan_pmt_ds.csv.gz",work_dir+"test_data_jan_pmt_ds_rcind.csv.gz"],
                  #[work_dir+"test_data_feb_pmt_ds.csv.gz",work_dir+"test_data_feb_pmt_ds_rcind.csv.gz"],
                  )
