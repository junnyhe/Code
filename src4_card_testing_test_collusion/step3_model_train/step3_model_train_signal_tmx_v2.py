...
def model_test_data_evaluation_comp_ruletag(test_data_file, var_list_filename, model_file, output_dir, output_suffix, good_downsample_rate,target_name):
...
if len(sys.argv) <=1:
    data_dir='/fraud_model/Data/card_testing_test_collusion/'
    support_dir='/fraud_model/Code/src4_card_testing_test_collusion/support_files/'
    result_dir='/fraud_model/Results/card_testing_test_collusion/'
elif len(sys.argv) ==4:
    data_dir=sys.argv[1]
...
for job in joblist:
    ...
    ks, auc, lorenz_curve_capt_rate, rule_model_rates = model_test_data_evaluation_comp_ruletag(test_data_file, var_list_filename, model_file, output_dir, output_suffix,good_downsample_rate,'target')
    ...
    ks, auc, lorenz_curve_capt_rate, rule_model_rates = model_test_data_evaluation_comp_ruletag(test_data_file, var_list_filename, model_file, output_dir, output_suffix,good_downsample_rate,'target_ct')
    result_summary.append(['-1mo']+format_results_one_case(ks, auc, lorenz_curve_capt_rate, good_downsample_rate) + rule_model_rates)# append results for one case to summary
    
    test_data_file = data_dir+'test_data_-2mo_pmt_ds_imp_woe.csv.gz'
    model_file = output_dir+"model.p"
    output_suffix = job[1]+'_-2mo'
    ks, auc, lorenz_curve_capt_rate, rule_model_rates = model_test_data_evaluation_comp_ruletag(test_data_file, var_list_filename, model_file, output_dir, output_suffix,good_downsample_rate,'target_ct')
    result_summary.append(['-2mo']+format_results_one_case(ks, auc, lorenz_curve_capt_rate, good_downsample_rate) + rule_model_rates)# append results for one case to summary
    
    test_data_file = data_dir+'test_data_-3mo_pmt_ds_imp_woe.csv.gz'
    model_file = output_dir+"model.p"
    output_suffix = job[1]+'_-3mo'
    ks, auc, lorenz_curve_capt_rate, rule_model_rates = model_test_data_evaluation_comp_ruletag(test_data_file, var_list_filename, model_file, output_dir, output_suffix,good_downsample_rate,'target_ct')
    result_summary.append(['-3mo']+format_results_one_case(ks, auc, lorenz_curve_capt_rate, good_downsample_rate) + rule_model_rates)# append results for one case to summary
