...
def rc_tmxrc_ind_creation_batch(input_file,output_file):
    ...
    rc_entry_filename=support_dir+'entry_list_reasoncode.csv'
    step1_rc_ind_creation = rc_ind_creation(rc_entry_filename)
    
    payer_tmxrc_entry_filename=support_dir+'entry_list_tmxrc_payer_selected.csv'
    payee_tmxrc_entry_filename=support_dir+'entry_list_tmxrc_payee_selected.csv'
    ...
    tmxrc_ind_select_var_filename=support_dir+'var_list_rc_tmxrc_ind_selected.csv'
