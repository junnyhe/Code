...
add_output_suffix='_120sigs'

################################ Load Data #####################################

data_dir='/Users/junhe/Documents/Data/Model_Data_Signal_Only/'
result_dir='/Users/junhe/Documents/Results/Model_Results_Signal_Only/' # importance>0.001
#var_list_filename='model_var_list.csv' # use all 142 signals
var_list_filename='model_var_list_120sigs.csv' # use top 120 signals given by random forest
#var_list_filename='model_var_list_95sigs.csv' # use top 97 signals given by random forest
#var_list_filename='model_var_list_50sigs.csv' # use top 50 signals given by random forest
#var_list_filename='model_var_list_30sigs.csv' # use top 30 signals given by random forest
...
for classifierName in classifierTestList:
    ...
    results.append((classifierName+add_output_suffix,errorRateInTest,auc,auct,auc-auct))
    print classifierName+add_output_suffix,":"
    print "error rate on test=",errorRateInTest,"; auc on test=",auct
