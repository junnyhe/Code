...
result_dir='/home/junhe/fraud_model/Results/Model_Results_Signal_Tmx_v3wd_tmxrc_ind/'
...
for job in joblist:
    ...
    ins_file=data_dir+'model_data_wd_ins_ds_tmxrc_ind.csv.gz'
    oos_file=data_dir+'model_data_wd_oos_ds_tmxrc_ind.csv.gz'
    ...
    test_data_file = data_dir+'model_data_wd_oos_ds_tmxrc_ind.csv.gz'
    ...
    test_data_file = data_dir+'test_data_sept_wd_ds_tmxrc_ind.csv.gz'
    model_file = output_dir+"model.p"
    ...
    test_data_file = data_dir+'test_data_oct_wd_ds_tmxrc_ind.csv.gz'
    model_file = output_dir+"model.p"
    ...
    test_data_file = data_dir+'test_data_nov_wd_ds_tmxrc_ind.csv.gz'
    model_file = output_dir+"model.p"
    ...
    test_data_file = data_dir+'test_data_dec_wd_ds_tmxrc_ind.csv.gz'
    model_file = output_dir+"model.p"
