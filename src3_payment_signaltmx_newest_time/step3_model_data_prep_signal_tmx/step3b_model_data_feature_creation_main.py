...
if __name__=="__main__":
    ...
    input_list = (
                  ...
                  [work_dir+"test_data_1mo_pmt_ds_rcind.csv.gz",work_dir+"test_data_1mo_pmt_ds_rcind_fc.csv.gz"],
                  [work_dir+"test_data_2mo_pmt_ds_rcind.csv.gz",work_dir+"test_data_2mo_pmt_ds_rcind_fc.csv.gz"],
                  [work_dir+"test_data_3mo_pmt_ds_rcind.csv.gz",work_dir+"test_data_3mo_pmt_ds_rcind_fc.csv.gz"],
                  [work_dir+"test_data_4mo_pmt_ds_rcind.csv.gz",work_dir+"test_data_4mo_pmt_ds_rcind_fc.csv.gz"],
                  [work_dir+"test_data_5mo_pmt_ds_rcind.csv.gz",work_dir+"test_data_5mo_pmt_ds_rcind_fc.csv.gz"],
                  [work_dir+"test_data_6mo_pmt_ds_rcind.csv.gz",work_dir+"test_data_6mo_pmt_ds_rcind_fc.csv.gz"],
                  )
